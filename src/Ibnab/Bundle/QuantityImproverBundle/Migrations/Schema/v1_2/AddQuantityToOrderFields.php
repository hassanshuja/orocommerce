...
namespace Ibnab\Bundle\QuantityImproverBundle\Migrations\Schema\v1_2;
...
class AddQuantityToOrderFields implements Migration, ExtendExtensionAwareInterface
{
    ...
    protected function addIncrementQuantityToOrderFieldsToProduct(Schema $schema)
    {
        $this->addFallbackRelation(
            ...
            'ibnab.quantity_improver.fields.product.enable_increment_quantity_to_order.label',
            [
                CategoryFallbackProvider::FALLBACK_ID => ['fieldName' => Inventory::FIELD_ENABLE_INCREMENT_QUANTITY_TO_ORDER],
                SystemConfigFallbackProvider::FALLBACK_ID => [
                    'configName' => 'ibnab_quantity_improver.enable',
                ],
            ]
        );
