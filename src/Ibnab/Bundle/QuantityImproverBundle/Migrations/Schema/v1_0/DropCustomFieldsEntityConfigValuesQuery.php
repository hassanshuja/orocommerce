...
class DropCustomFieldsEntityConfigValuesQuery extends ParametrizedMigrationQuery
{
    /**
     * @var string
     */
    ...
    {
        $key = sprintf('manyToOne|%s|%s|%s', $this->className, LocalizedFallbackValue::class, $this->fieldName);
